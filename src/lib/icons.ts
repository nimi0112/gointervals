/** Lucide icon paths (24x24, stroke). Shared by Astro components and the Preact island. */
...
export const ICON_PATHS: Record<IconName, string> = {
  ...
  'volume-x':
    speaker + '<line x1="22" x2="16" y1="9" y2="15"/><line x1="16" x2="22" y1="9" y2="15"/>',
...
export function iconSvg(name: IconName, size = 24, cls = ''): string {
