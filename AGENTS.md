...
4. Limits: interval work 1–3600 s (the main page edits Work 1–60 and Rest 0–60 in whole minutes; preset pages edit seconds), rest 0–3600 s, rounds 1–99; EMOM interval 15–300 s, minutes 1–99; Pomodoro minutes 1–180, sessions 1–12; meditation session 1–180 min, bell 1 min to the session length. Typed input is never coerced: invalid text stays visible with a specific inline error, `aria-describedby`, and a disabled Start. Steppers move by 1, clamp, disable at a bound and repeat after a 400ms hold.
